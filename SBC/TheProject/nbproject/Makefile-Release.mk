...
${OBJECTDIR}/Mapping.o: Mapping.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Mapping.o Mapping.cpp
...
${OBJECTDIR}/SoundProccessing.o: SoundProccessing.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SoundProccessing.o SoundProccessing.cpp
