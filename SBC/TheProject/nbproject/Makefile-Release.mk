...
${OBJECTDIR}/globals.o: globals.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/globals.o globals.cpp

${OBJECTDIR}/SerialComm.o: SerialComm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SerialComm.o SerialComm.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/TheMap.o: TheMap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TheMap.o TheMap.cpp

${OBJECTDIR}/MessageBuilder.o: MessageBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MessageBuilder.o MessageBuilder.cpp

${OBJECTDIR}/LogFile.o: LogFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LogFile.o LogFile.cpp

${OBJECTDIR}/SoundRecorder.o: SoundRecorder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SoundRecorder.o SoundRecorder.cpp

${OBJECTDIR}/SoundFFT.o: SoundFFT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SoundFFT.o SoundFFT.cpp

${OBJECTDIR}/ColorTracking.o: ColorTracking.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/include/opencv2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ColorTracking.o ColorTracking.cpp
